...
const BgSlider = () => {
  ...
  return (
    <div className='pb-10 md:py-20 mx-2'>
        {/* title */}
      <h1 className='mb-1 sm:mb-2 text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-900 bg-clip-text text-transparent'>Remove Background</h1>
