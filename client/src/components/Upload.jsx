...
const Upload = () => {
  return (
    <div className='pb-16'>
        {/**Title */}
        <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-4 mb-16 font-semibold bg-gradient-to-r from-gray-900 bg-clip-text text-transparent'>See the magic. Try now!</h1>
